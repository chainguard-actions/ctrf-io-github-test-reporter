...
describe('createCTRFReport with surefire retry functionality', () => {
    it('should handle flaky tests that eventually pass', () => {
                ...
                flakyFailures: [
                    {
                        ...
                        trace: 'java.lang.AssertionError: expected true but was false\\n\\tat com.example.MyTest.testFlakyFeature(MyTest.java:42)',
        ...
        expect(test.retryAttempts?.[0].message).toBe('Run 1 failed: expected true but was false');
        ...
        expect(test.retryAttempts?.[1].message).toBe('Run 2 failed: expected true but was false');
    ...
    it('should handle tests that fail in all retry attempts', () => {
        const testCases = [
            {
                ...
                time: '0.123',
                hasFailure: true,
                failureTrace: 'java.lang.AssertionError: expected true but was false\\n\\tat com.example.MyTest.testFlakyFeature(MyTest.java:42)',
        ...
        expect(test.retryAttempts?.[1].status).toBe('failed');
        expect(test.retryAttempts?.[1].message).toBe('NullPointerException occurred');
        expect(test.retryAttempts?.[1].stdout).toEqual([
