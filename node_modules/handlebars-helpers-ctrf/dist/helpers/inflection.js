 ...
 */
export const inflectHelper = {
    name: "inflect",
    category: "Inflection",
    fn: (count, singular, plural, includeCount = false) => {
...
export const inflectionHelpers = [inflectHelper, ordinalizeHelper];
