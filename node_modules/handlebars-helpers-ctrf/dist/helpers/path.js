 ...
 */
export const segmentsHelper = {
    name: "segments",
    category: "Path",
    fn: (filepath, start, end) => {
        if (typeof filepath !== "string")
            return "";
        ...
        if (Number.isNaN(s) || Number.isNaN(e) || s < 0 || e < s)
            return "";
