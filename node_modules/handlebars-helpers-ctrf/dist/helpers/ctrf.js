 ...
 */
export const sortTestsByFailRateHelper = {
    ...
    fn: (tests) => {
        ...
        const failedTests = testsCopy.filter((test) => typeof test === "object" &&
            test !== null &&
            "insights" in test &&
            test.insights &&
 ...
 */
export const sortTestsByFlakyRateHelper = {
    ...
    fn: (tests) => {
        ...
        const testsCopy = tests.slice();
        const flakyTests = testsCopy.filter((test) => typeof test === "object" &&
            test !== null &&
            "insights" in test &&
            test.insights &&
            typeof test.insights === "object" &&
 ...
 */
export const filterPassedTestsHelper = {
    ...
    fn: (tests) => {
        ...
        return tests.filter((test) => typeof test === "object" &&
            test !== null &&
            "status" in test &&
            test.status === "passed");
    },
 ...
 */
export const filterFailedTestsHelper = {
 ...
 */
export const filterOtherTestsHelper = {
 ...
 */
export const countFlakyTestsHelper = {
 ...
 */
export const anyFlakyTestsHelper = {
    name: "anyFlakyTests",
    category: "CTRF",
    fn: (tests) => {
        if (!Array.isArray(tests)) {
        ...
        return tests.some((test) => typeof test === "object" &&
            test !== null &&
            "flaky" in test &&
            test.flaky === true);
    },
 ...
 */
export const formatDurationFromTimesHelper = {
 ...
 */
export const formatTestMessageHelper = {
 ...
 */
export const formatTestMessagePreCodeHelper = {
 ...
 */
export const limitFailedTestsHelper = {
    ...
    fn: (tests, limit) => {
        ...
        const maxLimit = typeof limit === "number"
            ? limit
            : typeof limit === "string"
                ? parseInt(limit, 10)
                : 10;
        ...
        return tests
            .filter((test) => typeof test === "object" &&
            test !== null &&
            "status" in test &&
            test.status === "failed")
            .slice(0, validLimit);
 ...
 */
export const getCtrfEmojiHelper = {
    name: "getCtrfEmoji",
    category: "CTRF",
    fn: (status) => {
