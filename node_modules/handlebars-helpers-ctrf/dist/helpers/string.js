 ...
 */
export const capitalizeAllHelper = {
    name: "capitalizeAll",
    category: "String",
    fn: (str) => {
        if (typeof str !== "string") {
 ...
 */
export const occurrencesHelper = {
    name: "occurrences",
    category: "String",
    fn: (str, substring) => {
        if (typeof str !== "string" ||
 ...
 */
export const removeFirstHelper = {
    name: "removeFirst",
    category: "String",
    fn: (str, substring) => {
        if (typeof str !== "string" || typeof substring !== "string") {
 ...
 */
export const replaceFirstHelper = {
    name: "replaceFirst",
    category: "String",
    fn: (str, a, b) => {
        if (typeof str !== "string" ||
...
export const sentenceHelper = {
    ...
    fn: (str) => {
        ...
        return str.replace(/(^|[.!?]\s+)([a-z])/g, (_match, punctuation, letter) => punctuation + letter.toUpperCase());
    },
};
/**
 ...
 */
export const sliceStringHelper = {
    name: "sliceString",
    category: "String",
    fn: (str, start, end) => {
        if (typeof str !== "string") {
        ...
        const startIdx = typeof start === "number" ? start : parseInt(String(start), 10) || 0;
        // If end is provided, use it; otherwise slice to end of string
        if (end !== undefined) {
            const endIdx = typeof end === "number" ? end : parseInt(String(end), 10) || str.length;
 ...
 */
export const truncateWordsHelper = {
    name: "truncateWords",
    category: "String",
    fn: (str, limit, suffix = "...") => {
        if (typeof str !== "string") {
 ...
 */
export const escapeMarkdownHelper = {
    name: "escapeMarkdown",
    category: "String",
    fn: (str) => {
        if (typeof str !== "string") {
