 ...
 */
export const encodeURIComponentHelper = {
 ...
 */
export const decodeURIComponentHelper = {
 ...
 */
export const resolveUrlHelper = {
    name: "resolveUrl",
    category: "URL",
    fn: (base, href) => {
        if (typeof base !== "string" || typeof href !== "string")
            return "";
        try {
 ...
 */
export const stripQueryStringHelper = {
 ...
 */
export const stripProtocolHelper = {
    name: "stripProtocol",
    category: "URL",
    fn: (str) => {
        if (typeof str !== "string")
