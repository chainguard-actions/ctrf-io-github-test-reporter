...
export const containsHelper = {
    ...
    fn: (...args) => {
        ...
        if (Array.isArray(collection) || typeof collection === "string") {
            let idx = typeof startIndex === "number"
                ? startIndex
            ...
            if (typeof collection === "string") {
                found = collection.slice(idx).includes(value);
            }
            else {
                found = collection.slice(idx).includes(value);
            }
 ...
 */
export const ifNthHelper = {
    name: "ifNth",
    category: "Comparison",
    fn: (...args) => {
        const [a, b, options] = args;
        const result = typeof a === "number" && typeof b === "number" && b !== 0 && a % b === 0;
        if (options &&
            typeof options.fn ===
                "function") {
            return result
...
export const orHelper = {
    ...
    fn: (...args) => {
        ...
        if (args.length > 0 &&
            ...
            typeof args[args.length - 1].fn === "function") {
