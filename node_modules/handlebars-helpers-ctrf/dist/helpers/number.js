 ...
 */
export const abbreviateNumberHelper = {
 ...
 */
export const toExponentialHelper = {
    name: "toExponential",
    category: "Number",
    fn: (number, fractionDigits) => {
        if (typeof number !== "number" || Number.isNaN(number)) {
            return "0";
        }
        ...
        else if (typeof fractionDigits === "number" &&
 ...
 */
export const toPrecisionHelper = {
    name: "toPrecision",
    category: "Number",
    fn: (number, precision) => {
        if (typeof number !== "number" || Number.isNaN(number)) {
 ...
 */
export const toPercentHelper = {
    name: "toPercent",
    category: "Number",
    fn: (rate, fractionDigits) => {
