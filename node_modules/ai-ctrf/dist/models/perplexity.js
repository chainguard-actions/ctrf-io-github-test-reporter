...
exports.perplexityFailedTestSummary = perplexityFailedTestSummary;
const openai_1 = __importDefault(require("openai"));
const common_1 = require("../common");
const consolidated_summary_1 = require("../consolidated-summary");
const constants_1 = require("../constants");
function perplexity(systemPrompt, prompt, args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield client.chat.completions.create(Object.assign(Object.assign({ model: args.model || "sonar-reasoning-pro", messages: [
...
function perplexityFailedTestSummary(report_1, args_1, file_1) {
    return __awaiter(this, arguments, void 0, function* (report, args, file, log = false) {
        ...
        for (const test of failedTests) {
            ...
            const response = yield perplexity(systemPrompt, prompt, args);
            if (response) {
                test.ai = response;
                messageCount++;
                if (args.log && !logged) {
        ...
        if (args.consolidate) {
            yield (0, consolidated_summary_1.generateConsolidatedSummary)(report, "perplexity", args);
        }
        if (file) {
